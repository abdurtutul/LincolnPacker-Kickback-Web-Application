...
Use Notion to manage QA lifecycle and assign bugs to developers with updates tracked per status (Open, Fixed, Retested, Closed).
Include Notion URLs in pull request descriptions or commit messages when resolving related issues.
